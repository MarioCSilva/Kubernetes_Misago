...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "0.0.0.0", os.environ.get("ALLOWED_HOST")]
...
MISAGO_USER_DATA_DOWNLOADS_WORKING_DIR = os.path.join(BASE_DIR, "static/userdata")


# Path to directory containing avatar galleries
# Those galleries can be loaded by running loadavatargallery command

MISAGO_AVATAR_GALLERY = os.path.join(BASE_DIR, "static/avatargallery")
