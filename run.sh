...
kubectl exec -n gic6 -it $MISAGO -- /bin/bash -c "mkdir /srv/misago/static/static && cp -r /srv/misago/misago/static/* /srv/misago/static/static && cp -r /srv/misago/promopage /srv/misago/static"
